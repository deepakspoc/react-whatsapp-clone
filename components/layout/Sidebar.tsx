import {CircleFadingPlus,EllipsisVertical,MessageCircleCode,MessageSquare,MessageSquarePlus,PanelTopOpen,SearchIcon,Settings,User,Users,} from "lucide-react";
      ...
      <div className="bg-primary/90 w-15 items-center justify-between px-4 flex flex-col">
        <div className="flex-col mt-2 gap-2 items-center justify-between flex">
          ...
          <button className="relative size-10 hover:cursor-pointer bg-gray-500 grid place-items-center rounded-full">
            <span className="absolute -top-1 -right-1 size-5 text-xs grid place-items-center bg-green-700 rounded-full">10</span>
          ...
          <button className="relative size-10 hover:cursor-pointer grid place-items-center rounded-full">
           ...
           <span><CircleFadingPlus /></span>
          </button>
          {/*CHANNELS */}
          <button className="relative size-10 hover:cursor-pointer grid place-items-center rounded-full">
           <span><MessageCircleCode /></span>
          </button>
          {/* USERS */}
          <button className="relative size-10 hover:cursor-pointer grid place-items-center rounded-full">
            <span><Users /></span>
        ...
        <div>
          ...
          <div className="gap-4 px-6 flex items-center mt-4 w-full">
            <div className=" size-8 text-green-500 bg-[#202C33] rounded-full ">
              <button className="size-8 grid place-items-center hover:cursor-pointer">All</button>
            </div>
            <div className="p-1 text-[#AEBAC1] bg-[#202C33] rounded-full ">
              <button className="grid place-items-center hover:cursor-pointer">Unread</button>
            </div>
            <div className="p-1 text-[#AEBAC1] bg-[#202C33] rounded-full ">
