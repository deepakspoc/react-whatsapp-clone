  ...
  return (
    <nav className="bg-primary/90 h-15 flex items-center justify-between px-4 ">
      <div className="flex gap-2 ">
        <button className=" w-10 h-10 overflow-hidden mt-2 rounded-full hover:cursor-pointer">
          <Image
      ...
      <div className="flex gap-2">
        <div className="flex gap-2 px-2 py-1 rounded-full border border-[#54656F]">
          <button>
            <Video className="text-[#54656F] hover:cursor-pointer" />
          </button>
          <button>
            <ChevronDown className="text-[#54656F] hover:cursor-pointer" />
          </button>
        </div>
        <button>
